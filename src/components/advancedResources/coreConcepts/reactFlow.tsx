...
const cards = ['Hello', 'World', 'karera', 'olivier', 'Nkuru nziza karera', 'susu', 'Green', 'John Doe', 'Marketing'];


const initialNodes = cards.map((card, index) => generateNode((index + 1).toString(), card));
