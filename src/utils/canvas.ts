...
export const generateEdge = (
    ...
    interactionWidth: 3,
    animated: false,
    style: { stroke: "#4e5157", strokeWidth: 2, strokeDasharray: "5"},
...
export const parseEdges = (data: any[]) => data.flatMap((element: any, index: any) => {
...
export const parseNodes = (data: any[], container: {
    width: number;
    height: number;
}) => {
