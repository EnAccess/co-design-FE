...
export const Header= () => {
  ...
  return (
    ...
    <Link href="/case-studies-and-core-tools"
      className={`flex items-center justify-center rounded-lg border border-gray-500 bg-gray-400 font-semibold text-xs min-h-10 w-40 text-center cursor-pointer ${
...
<p className="text-center text-gray-500 text-sm mb-3">Select Level of Co-design Practice</p>
  <div className="">
      ...
      />
      <div className="min-h-80">
      <p className="text-center text-gray-500 text-sm mb-3">Select Step in The Co-design Journey</p>
